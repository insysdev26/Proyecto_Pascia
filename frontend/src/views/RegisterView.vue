...
// URL apuntando a la IP de tu red local en el puerto de la API
const API_URL = 'https://192.168.1.126:7123/api/auth/register'
...
<template>
  <div class="flex min-h-screen items-center justify-center bg-slate-950 p-4 relative">
    ...
    <form class="form" @submit.prevent="handleRegister">
      ...
      <p v-if="errorMessage" class="text-xs text-red-400 text-center font-semibold -mt-2 mb-2">
        {{ errorMessage }}
      </p>
      ...
      <div class="field">
        ...
        <input v-model="username" autocomplete="off" placeholder="Nombre de usuario" class="input-field" type="text" required />
      </div>
      ...
      <div class="field">
        ...
        <input v-model="confirmPassword" placeholder="Confirmar contraseña" class="input-field" type="password" required />
      </div>
      ...
      <button type="button" class="button3" @click="goToLogin">
